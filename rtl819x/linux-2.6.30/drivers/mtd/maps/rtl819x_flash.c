...
extern int get_flash_sector_size(unsigned char ucChip);
#endif
...
#ifdef AEI_WECB
    //modified rtl8196_parts1 for new flash
    if(get_flash_sector_size(0) == SIZE_004K)
    {
        rtl8196_parts1[4].size = CONFIG_RTL_FLASH_SIZE-CONFIG_RTL_ACT_CONF_OFFSET_4K_FLASH;
        rtl8196_parts1[4].offset = CONFIG_RTL_FLASH_DUAL_IMAGE_OFFSET+CONFIG_RTL_ACT_CONF_OFFSET_4K_FLASH;
    }
#endif
