...
{0x0012018, 0x00, SIZE2N_16MB, SIZE_064K, SIZE_064K, SIZE_256B, "S25FL128P"
#if (SPI_DRIVER_MODE == 1)
, 104, ComSrlCmd_BE,  SpiRead_1443EB, span_spi_setQEBit,  PageWrite_114032
#else
, 104, ComSrlCmd_BE,  SpiRead_11110B, ComSrlCmd_NoneQeBit,  PageWrite_111002
#endif
},
...
#ifdef AEI_WECB
int get_flash_sector_size(unsigned char ucChip)
{

    return spi_flash_info[ucChip].sector_size;
}
EXPORT_SYMBOL(get_flash_sector_size);
#endif
