...
/* #define CONFIG_RTL_SET_BROADCAST_HW_LOOKUP 1 // move to DEFINES */
...
#if defined(CONFIG_RTL_SET_BROADCAST_HW_LOOKUP)
	else if (((skb->data[0]&0xff)==0xff)&&((skb->data[1]&0xff)==0xff)) {
		rtl_hwLookup_txInfo(txInfo);
	}
#endif
	else {
