...
extern void actAdvsyslog(request *wp, char *path, char *query);
extern void actAdvtr69(request *wp, char *path, char *query);
extern void actAdvLocalSsh(request *wp, char *path, char *query);
extern void actAdvTimeZone(request *wp, char *path, char *query);
extern void actgetSshParams(char *parambuf);
extern void actgetTimeZoneParams(char *parambuf);
