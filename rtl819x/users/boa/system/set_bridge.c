...
//printf("\r\n tmpBuff=[%s],__[%s-%u]\r\n",tmpBuff,__FILE__,__LINE__);
    ...
    system( "cli -s Device.Bridging.Bridge.4.Port.3.X_ACTIONTEC_COM_Trigger int 1" ); // 5G
    // For Xfinity
    system( "cli -s Device.Bridging.Bridge.3.Port.3.X_ACTIONTEC_COM_Trigger int 1" );
    system( "cli -s Device.Bridging.Bridge.5.Port.3.X_ACTIONTEC_COM_Trigger int 1" ); // 5G
#endif
