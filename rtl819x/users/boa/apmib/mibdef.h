...
MIBDEF(unsigned char,   mp_hw_ver, [8+1], MP_HW_VER, STRING_T, APMIB_T, 0, 0)
...
// WMM parameter
MIBDEF(unsigned char,   wmmAifsnBe, , WMM_AIFSN_BE, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwminBe, , WMM_ECWMIN_BE, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwmaxBe, , WMM_ECWMAX_BE, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmTxopBe, , WMM_TXOP_BE, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmAifsnBk, , WMM_AIFSN_BK, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwminBk, , WMM_ECWMIN_BK, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwmaxBk, , WMM_ECWMAX_BK, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmTxopBk, , WMM_TXOP_BK, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmTxopVi, , WMM_TXOP_VI, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmAifsnVi, , WMM_AIFSN_VI, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwminVi, , WMM_ECWMIN_VI, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwmaxVi, , WMM_ECWMAX_VI, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmTxopVo, , WMM_TXOP_VO, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmAifsnVo, , WMM_AIFSN_VO, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwminVo, , WMM_ECWMIN_VO, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
MIBDEF(unsigned char,   wmmEcwmaxVo, , WMM_ECWMAX_VO, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
