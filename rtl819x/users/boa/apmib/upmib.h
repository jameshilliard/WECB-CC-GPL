...
#define AEI_MIB_VER		"21" //this macro must update when modify update_mib or new_mib
...
//add mib info here
	// Current Setting
		...
		{MIB_WLAN_WMM_AIFSN_BE, 	"WLAN0_VAP0_WMM_AIFSN_BE",	"7",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BE, 	"WLAN0_VAP0_WMM_ECWMIN_BE",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BE, 	"WLAN0_VAP0_WMM_ECWMAX_BE",	"10",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BE, 	"WLAN0_VAP0_WMM_TXOP_BE",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_BK, 	"WLAN0_VAP0_WMM_AIFSN_BK",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BK, 	"WLAN0_VAP0_WMM_ECWMIN_BK",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BK, 	"WLAN0_VAP0_WMM_ECWMAX_BK",	"6",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BK, 	"WLAN0_VAP0_WMM_TXOP_BK",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VI, 	"WLAN0_VAP0_WMM_AIFSN_VI",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VI, 	"WLAN0_VAP0_WMM_ECWMIN_VI",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VI, 	"WLAN0_VAP0_WMM_ECWMAX_VI",	"4",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VI, 	"WLAN0_VAP0_WMM_TXOP_VI",	"188",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VO, 	"WLAN0_VAP0_WMM_AIFSN_VO",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VO, 	"WLAN0_VAP0_WMM_ECWMIN_VO",	"2",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VO, 	"WLAN0_VAP0_WMM_ECWMAX_VO",	"3",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VO, 	"WLAN0_VAP0_WMM_TXOP_VO",	"102",	BYTE_T},

		{MIB_WLAN_WMM_AIFSN_BE, 	"WLAN1_VAP0_WMM_AIFSN_BE",	"7",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BE, 	"WLAN1_VAP0_WMM_ECWMIN_BE",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BE, 	"WLAN1_VAP0_WMM_ECWMAX_BE",	"10",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BE, 	"WLAN1_VAP0_WMM_TXOP_BE",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_BK, 	"WLAN1_VAP0_WMM_AIFSN_BK",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BK, 	"WLAN1_VAP0_WMM_ECWMIN_BK",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BK, 	"WLAN1_VAP0_WMM_ECWMAX_BK",	"6",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BK, 	"WLAN1_VAP0_WMM_TXOP_BK",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VI, 	"WLAN1_VAP0_WMM_AIFSN_VI",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VI, 	"WLAN1_VAP0_WMM_ECWMIN_VI",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VI, 	"WLAN1_VAP0_WMM_ECWMAX_VI",	"4",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VI, 	"WLAN1_VAP0_WMM_TXOP_VI",	"188",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VO, 	"WLAN1_VAP0_WMM_AIFSN_VO",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VO, 	"WLAN1_VAP0_WMM_ECWMIN_VO",	"2",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VO, 	"WLAN1_VAP0_WMM_ECWMAX_VO",	"3",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VO, 	"WLAN1_VAP0_WMM_TXOP_VO",	"102",	BYTE_T},

		{MIB_WLAN_STA_NUM,	"WLAN0_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN0_VAP0_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN0_VAP1_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN0_VAP2_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN0_VAP3_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN1_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN1_VAP0_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN1_VAP1_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN1_VAP2_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"WLAN1_VAP3_STA_NUM",	"0",	BYTE_T},
#endif
        {0}
};
...
//add mib info here
	...
	{MIB_DUALBANK_ENABLED,              "DEF_DUALBANK_ENABLED",                 "1",	BYTE_T},
		...
		{MIB_WLAN_WMM_AIFSN_BE, 	"DEF_WLAN0_VAP0_WMM_AIFSN_BE",	"7",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BE, 	"DEF_WLAN0_VAP0_WMM_ECWMIN_BE",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BE, 	"DEF_WLAN0_VAP0_WMM_ECWMAX_BE",	"10",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BE, 	"DEF_WLAN0_VAP0_WMM_TXOP_BE",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_BK, 	"DEF_WLAN0_VAP0_WMM_AIFSN_BK",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BK, 	"DEF_WLAN0_VAP0_WMM_ECWMIN_BK",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BK, 	"DEF_WLAN0_VAP0_WMM_ECWMAX_BK",	"6",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BK, 	"DEF_WLAN0_VAP0_WMM_TXOP_BK",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VI, 	"DEF_WLAN0_VAP0_WMM_AIFSN_VI",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VI, 	"DEF_WLAN0_VAP0_WMM_ECWMIN_VI",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VI, 	"DEF_WLAN0_VAP0_WMM_ECWMAX_VI",	"4",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VI, 	"DEF_WLAN0_VAP0_WMM_TXOP_VI",	"188",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VO, 	"DEF_WLAN0_VAP0_WMM_AIFSN_VO",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VO, 	"DEF_WLAN0_VAP0_WMM_ECWMIN_VO",	"2",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VO, 	"DEF_WLAN0_VAP0_WMM_ECWMAX_VO",	"3",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VO, 	"DEF_WLAN0_VAP0_WMM_TXOP_VO",	"102",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_BE, 	"DEF_WLAN1_VAP0_WMM_AIFSN_BE",	"7",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BE, 	"DEF_WLAN1_VAP0_WMM_ECWMIN_BE",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BE, 	"DEF_WLAN1_VAP0_WMM_ECWMAX_BE",	"10",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BE, 	"DEF_WLAN1_VAP0_WMM_TXOP_BE",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_BK, 	"DEF_WLAN1_VAP0_WMM_AIFSN_BK",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_BK, 	"DEF_WLAN1_VAP0_WMM_ECWMIN_BK",	"4",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_BK, 	"DEF_WLAN1_VAP0_WMM_ECWMAX_BK",	"6",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_BK, 	"DEF_WLAN1_VAP0_WMM_TXOP_BK",	"0",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VI, 	"DEF_WLAN1_VAP0_WMM_AIFSN_VI",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VI, 	"DEF_WLAN1_VAP0_WMM_ECWMIN_VI",	"3",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VI, 	"DEF_WLAN1_VAP0_WMM_ECWMAX_VI",	"4",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VI, 	"DEF_WLAN1_VAP0_WMM_TXOP_VI",	"188",	BYTE_T},
		{MIB_WLAN_WMM_AIFSN_VO, 	"DEF_WLAN1_VAP0_WMM_AIFSN_VO",	"1",	BYTE_T},
		{MIB_WLAN_WMM_ECWMIN_VO, 	"DEF_WLAN1_VAP0_WMM_ECWMIN_VO",	"2",	BYTE_T},
		{MIB_WLAN_WMM_ECWMAX_VO, 	"DEF_WLAN1_VAP0_WMM_ECWMAX_VO",	"3",	BYTE_T},
		{MIB_WLAN_WMM_TXOP_VO, 	"DEF_WLAN1_VAP0_WMM_TXOP_VO",	"102",	BYTE_T},

		{MIB_WLAN_STA_NUM,	"DEF_WLAN0_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN0_VAP0_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN0_VAP1_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN0_VAP2_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN0_VAP3_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN1_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN1_VAP0_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN1_VAP1_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN1_VAP2_STA_NUM",	"0",	BYTE_T},
		{MIB_WLAN_STA_NUM,	"DEF_WLAN1_VAP3_STA_NUM",	"0",	BYTE_T},
#endif
        {0}
};
