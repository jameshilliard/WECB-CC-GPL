...
//!CONFIG_RTL_8196B => rtl8651c+rtl8190
	...
	// set band
        ...
        // set WMM parameters
        apmib_get(MIB_WLAN_WMM_AIFSN_BE, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[1].AIFSN = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMIN_BE, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[1].ECWmin = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMAX_BE, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[1].ECWmax = intVal;
        apmib_get(MIB_WLAN_WMM_TXOP_BE, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[1].TXOPlimit = intVal;

        apmib_get(MIB_WLAN_WMM_AIFSN_BK, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[0].AIFSN = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMIN_BK, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[0].ECWmin = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMAX_BK, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[0].ECWmax = intVal;
        apmib_get(MIB_WLAN_WMM_TXOP_BK, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[0].TXOPlimit = intVal;

        apmib_get(MIB_WLAN_WMM_AIFSN_VI, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[2].AIFSN = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMIN_VI, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[2].ECWmin = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMAX_VI, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[2].ECWmax = intVal;
        apmib_get(MIB_WLAN_WMM_TXOP_VI, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[2].TXOPlimit = intVal;

        apmib_get(MIB_WLAN_WMM_AIFSN_VO, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[3].AIFSN = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMIN_VO, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[3].ECWmin = intVal;
        apmib_get(MIB_WLAN_WMM_ECWMAX_VO, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[3].ECWmax = intVal;
        apmib_get(MIB_WLAN_WMM_TXOP_VO, (void *)&intVal);
        pmib->dot11QosEntry.AP_manualEDCA[3].TXOPlimit = intVal;
